...
public class TestDaoAdresse1 {
    ...
    public static void test1_SelectUnique(int idAdresse) throws SQLException {
        Adresse1 cetteAdresse = DaoAdresse1.selectOne(idAdresse);
    ...
    public static void test2_SelectMultiple() throws SQLException {
        List<Adresse1> desAdresses = DaoAdresse1.selectAll();
    ...
    public static void test3_Insert(int idAdresse) throws SQLException {
        Adresse1 uneAdresse = new Adresse1(idAdresse, "141 route de Clisson", new Ville(1, null, null, null, 10000));
        int nb = DaoAdresse1.insert(idAdresse, uneAdresse);
    ...
    public static void test4_Update(int idAdresse) throws SQLException {
        Adresse1 uneAdresse = new Adresse1(idAdresse, "143 route de Clisson", new Ville(2, null, null, null, 10000));
        int nb = DaoAdresse1.update(idAdresse, uneAdresse);
    ...
    public static void test5_Delete(int idAdresse) throws SQLException {
        int nb = DaoAdresse1.delete(idAdresse);
    ...
    public static void test6_SelectMultiple(int cleTri, int ordreTri) throws SQLException {
        List<Adresse1> desAdresses = DaoAdresse1.selectAll(cleTri, ordreTri);
        System.out.println("Les adresses lues : " + desAdresses.toString());
    }
}
